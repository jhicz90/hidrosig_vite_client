...
import { blockApi, searchPolygonObject, useUpdateBlockByIdMutation } from '../../../store/actions'

export const BlockAreaGeometry = () => {
    
    const { blkid } = useParams()
    const { data = null } = useSelector(blockApi.endpoints.getBlockById.select(blkid))
    const [updateBlock, { isLoading: isUpdating }] = useUpdateBlockByIdMutation()
