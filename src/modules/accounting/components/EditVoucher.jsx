...
const EditVoucherWindow = ({ id }) => {
    ...
    const handleDeleteImageVoucher = (imageId) => {
        dispatch(startDeleteImageVoucher(data._id, imageId))
    }

    const handleDeleteVoucher = async () => {
        try {
            const { _id, serie, numReceipt } = data
            ...
            <Offcanvas.Header closeButton={!isSaving || !isDeleting} closeVariant='white'>
                <Offcanvas.Title>
                    <div className='d-flex flex-column'>
                        ...
                        <span>{!!data ? `${data.serie}-${data.numReceipt}` : 'Cargando...'}</span>
                    </div>
                </Offcanvas.Title>
            </Offcanvas.Header>
            {
                (!!data && !isLoading)
                    ...
                    <>
                        ...
                        <Offcanvas.Body>
                            <form id='form-accounting-voucher-edit' onSubmit={handleSubmit(handleUpdate)}>
                                <div className='row'>
