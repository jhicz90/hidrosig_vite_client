...
import { editActiveNewVoucher, searchSocialReason, startSaveNewVoucher, useAddVoucherMutation, useNewVoucherQuery } from '../../../store/actions'
...
const CreateVoucherWindow = ({ ptt = null }) => {
    ...
    const { data = null, isLoading } = useNewVoucherQuery(ptt, { refetchOnMountOrArgChange: true })
    const [addVoucher, { isLoading: isSaving, isSuccess }] = useAddVoucherMutation()
