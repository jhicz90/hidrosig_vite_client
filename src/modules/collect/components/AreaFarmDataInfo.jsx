            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    }
                    {
                        ...
                        &&
                        <Button variant='link' size='sm' onClick={() => setShowMore(!showMore)}>Ver {showMore ? 'menos' : 'más'}</Button>
                    }
                </Card.Body>
            </Card>
            {
                ...
                <Card className='mt-3'>
                    ...
                    <ListGroup variant='flush'>
                        {
                            data?.inputIrrig.map(inputIrr =>
                                <ListGroup.Item key={`inputirrig_${inputIrr._id}`}>
                                    <OptionInputIrrig inputIrrig={inputIrr} />
                                </ListGroup.Item>
                            )
                        }
                    </ListGroup>
