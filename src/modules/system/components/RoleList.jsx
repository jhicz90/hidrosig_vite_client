...
import { useGetRolesQuery } from '../../../store/actions'

export const RoleList = () => {

    const [search, setSearch] = useState('')
    const { data: list = [], isFetching } = useGetRolesQuery(search)
