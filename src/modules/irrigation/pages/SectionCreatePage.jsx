                ...
                <div className='col-12'>
                    <div className='row align-items-center justify-content-between g-3'>
                        <div className='col-12 col-md-auto'>
                            <h4 className='mb-0'>NUEVO TRAMO</h4>
                        </div>
                        <div className='col-12 col-md-auto'>
                    ...
                    <div className='row mb-1'>
                        <div className='col-6'>
                            <div className='input-group input-group-sm'>
                                ...
                                <input value={data?.limitStructure.structureName || ''} readOnly type='text' className='form-control col-8' />
                            </div>
                        </div>
                        <div className='col-6'>
                            <div className='input-group input-group-sm'>
                                <span className='input-group-text col-4'>Total de tramos</span>
                                <input value={data?.limitStructure.countSections || 0} readOnly type='text' className='form-control col-8' />
                            </div>
                        </div>
                    </div>
                    <div className='row mb-1'>
                        <div className='col-6'>
                            <div className='input-group input-group-sm'>
                                ...
                                <input value={data?.limitStructure.distanceTotal || 0} readOnly type='text' className='form-control col-8' />
                            </div>
                        </div>
                        <div className='col-6'>
                            <div className='input-group input-group-sm'>
                                <span className='input-group-text col-4'>Longitud restante</span>
                                <input value={data?.limitStructure.limit || 0} readOnly type='text' className='form-control col-8' />
                            </div>
                        </div>
                    </div>
                </div>
